...
export const RichTextComponents = {
  ...
  //   return <PortableText value={props.value} components={myPortableTextComponents} />
    ...
    block: {
      ...
      h1: ({children} : any) => <h1 className="text-4xl lg:text-6xl py-2 my-3 uppercase font-mono text-green-700">{children}</h1>,
      h2: ({children} : any) => <h1 className="text-3xl  lg:text-5xl py-2 my-3 uppercase font-mono text-green-700">{children}</h1>,
      h3: ({children} : any) => <h1 className="text-2xl  lg:text-4xl py-2 my-3 uppercase font-mono text-green-700">{children}</h1>,
      h4: ({children} : any) => <h1 className="text-xl  lg:text-3xl py-2 my-3 uppercase font-mono text-green-700">{children}</h1>,
